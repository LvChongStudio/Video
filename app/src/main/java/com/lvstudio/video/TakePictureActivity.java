...
public class TakePictureActivity extends Activity implements View.OnClickListener {
            ...
            imageReader.setOnImageAvailableListener(
                    new ImageReader.OnImageAvailableListener() {
                        ...
                        public void onImageAvailable(ImageReader reader) {
                            ...
                            // 使用IO流将照片写入指定文件
                            File file = new File(Environment.getExternalStorageDirectory(), "/takeVideo/pic.jpg");
                            if (!file.exists()) {
                                File dir = new File(Environment.getExternalStorageDirectory(), "/takeVideo/");
                                dir.mkdirs();
                            }
                            buffer.get(bytes);
                            try (
    ...
    private static Size chooseOptimalSize(Size[] choices
        ...
        for (Size option : choices) {
            Log.d("chooseOptimalSize", "w : " + option.getWidth());
            Log.d("chooseOptimalSize", "h : " + option.getHeight());
